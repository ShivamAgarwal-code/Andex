...
export const getBunnyFactoryContract = (signer?: WalletClient) => {
  return getContract({
    abi: bunnyFactoryABI,
    address: getBunnyFactoryAddress(),
    signer,
  });
};
...
export const getTradingCompetitionContractFanToken = (
  signer?: WalletClient
) => {
  return getContract({
...
export const getCakeVaultV2Contract = (
  signer?: WalletClient,
  chainId?: number
) => {
  return getContract({
...
export const getCakeFlexibleSideVaultV2Contract = (
  signer?: WalletClient,
  chainId?: number
) => {
  return getContract({
...
export const getPredictionsV2Contract = (
  address: Address,
  signer?: WalletClient
) => {
...
export const getPredictionsV1Contract = (signer?: WalletClient) => {
  return getContract({
    abi: predictionsV1ABI,
    address: getPredictionsV1Address(),
    signer,
  });
};

export const getCakePredictionsContract = (
  address: Address,
  signer?: WalletClient
) => {
...
export const getPancakeSquadContract = (signer?: WalletClient) => {
  return getContract({
    abi: pancakeSquadABI,
    address: getPancakeSquadAddress(),
    signer,
  });
};

export const getPotteryVaultContract = (
  address: Address,
  walletClient?: WalletClient
) => {
...
export const getIfoCreditAddressContract = (signer?: WalletClient) => {
  return getIfoCreditAddressContract_(
...
export const getBCakeFarmBoosterV3Contract = (
  signer?: WalletClient,
  chainId?: number
) => {
  return getContract({
...
export const getPositionManagerWrapperContract = (
  address: `0x${string}`,
  signer?: WalletClient,
  chainId?: number
) => {
...
export const getPositionManagerAdapterContract = (
  address: `0x${string}`,
  signer?: WalletClient,
  chainId?: number
) => {
...
export const getBCakeFarmBoosterProxyFactoryContract = (
  signer?: WalletClient
) => {
  return getContract({
...
export const getBCakeProxyContract = (
...
export const getNonBscVaultContract = (
  signer?: WalletClient,
  chainId?: number
) => {
  return getContract({
...
export const getSidResolverContract = (
  address: Address,
  signer?: WalletClient
) => {
...
export const getCrossFarmingSenderContract = (
  signer?: WalletClient,
  chainId?: number
) => {
  return getContract({
...
export const getCrossFarmingReceiverContract = (
  signer?: WalletClient,
  chainId?: number
) => {
  return getContract({
...
export const getStableSwapNativeHelperContract = (
  signer?: WalletClient,
  chainId?: number
) => {
  return getContract({
...
export const getMasterChefV3Contract = (
  signer?: WalletClient,
  chainId?: number
) => {
...
export const getV3MigratorContract = (
  signer?: WalletClient,
  chainId?: number
) => {
  return getContract({
...
export const getTradingRewardContract = (
  signer?: WalletClient,
  chainId?: number
) => {
  return getContract({
...
export const getAffiliateProgramContract = (
  signer?: WalletClient,
  chainId?: number
) => {
  return getContract({
...
export const getTradingRewardTopTradesContract = (
  signer?: WalletClient,
  chainId?: number
) => {
  return getContract({
...
export const getRevenueSharingPoolContract = (
  signer?: WalletClient,
  chainId?: number
) => {
  return getContract({
...
export const getAnniversaryAchievementContract = (
  signer?: WalletClient,
  chainId?: number
) => {
  return getContract({
...
export const getFixedStakingContract = (
  signer?: WalletClient,
  chainId?: number
) => {
  return getContract({
...
export const getVeCakeContract = (signer?: WalletClient, chainId?: number) => {
  return getContract({
    abi: veCakeABI,
    address:
      getVeCakeAddress(chainId) ?? getVeCakeAddress(ChainId.MODE_MAINNET),
    signer,
    chainId,
  });
};

export const getGaugesVotingContract = (
  signer?: WalletClient,
  chainId?: number
) => {
  return getContract({
    abi: gaugesVotingABI,
    address:
      getGaugesVotingAddress(chainId) ??
      getGaugesVotingAddress(ChainId.MODE_MAINNET),
    signer,
    chainId,
  });
};

export const getCalcGaugesVotingContract = (
  signer?: WalletClient,
  chainId?: number
) => {
  return getContract({
    ...
    address:
      getCalcGaugesVotingAddress(chainId) ??
      getCalcGaugesVotingAddress(ChainId.MODE_MAINNET),
    signer,
    chainId,
  });
};

export const getRevenueSharingCakePoolContract = (
  signer?: WalletClient,
  chainId?: number
) => {
  return getContract({
    ...
    address:
      getRevenueSharingCakePoolAddress(chainId) ??
      getRevenueSharingCakePoolAddress(ChainId.MODE_MAINNET),
    signer,
    chainId,
  });
};

export const getRevenueSharingVeCakeContract = (
  signer?: WalletClient,
  chainId?: number
) => {
  return getContract({
    abi: revenueSharingPoolProxyABI,
    address:
      getRevenueSharingVeCakeAddress(chainId) ??
      getRevenueSharingVeCakeAddress(ChainId.MODE_MAINNET),
    signer,
    chainId,
  });
};

export const getRevenueSharingPoolGatewayContract = (
  signer?: WalletClient,
  chainId?: number
) => {
  return getContract({
    ...
    address:
      getRevenueSharingPoolGatewayAddress(chainId) ??
      getRevenueSharingPoolGatewayAddress(ChainId.MODE_MAINNET),
    signer,
    chainId,
  });
};
