...
const WalletInfo: React.FC<WalletInfoProps> = ({
  ...
  const wBNBToken = WNATIVE[ChainId.MODE_MAINNET];
    ...
    <>
      <Box maxWidth="140px">
        ...
        >
          <Text as="p">
            {t(
              "%currency% Balance Low. You need %currency% for transaction fees.",
              {
    ...
    <>
          ...
          <Flex alignItems="center" justifyContent="space-between">
            ...
            {!nativeBalance.isFetched ? (
              ...
              <Flex>
                ...
                {buyCryptoTooltipVisible &&
                  (!isMobile || mobileTooltipShow) &&
                  buyCryptoTooltip}
              </Flex>
            )}
          </Flex>
      ...
      <Box mb="24px">
        <Flex justifyContent="space-between" alignItems="center" mb="8px">
          ...
          <ScanLink
            useBscCoinFallback
            href={getBlockExploreLink(account, "address", ChainId.MODE_MAINNET)}
          >
            {getBlockExploreName(ChainId.MODE_MAINNET)}
          </ScanLink>
        </Flex>
        {chainId === 56 ? (
          <Flex alignItems="center" justifyContent="space-between">
