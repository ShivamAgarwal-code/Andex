...
export const DEFAULT_META: PageMeta = {
  title: "Andex",
  description:
    "The most popular AMM on MODE by user count! Earn ANDX through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by Andex), and more, on a platform you can trust.",
