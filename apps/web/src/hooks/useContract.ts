...
export const useCake = () => {
  ...
  return useContract(
    (chainId && ANDX[chainId]?.address) ?? ANDX[ChainId.MODE_MAINNET].address,
    erc20ABI
  );
};
...
export const useMasterchef = () => {
  ...
  const { data: signer } = useWalletClient();
  return useMemo(
    () => getMasterChefContract(signer ?? undefined, chainId),
    [signer, chainId]
  );
};
...
export const usePointCenterIfoContract = () => {
  const { data: signer } = useWalletClient();
  return useMemo(
    () => getPointCenterIfoContract(signer ?? undefined),
    [signer]
  );
};
...
export const useTradingCompetitionContractEaster = () => {
  const { data: signer } = useWalletClient();
  return useMemo(
    () => getTradingCompetitionContractEaster(signer ?? undefined),
    [signer]
  );
};
...
export const useTradingCompetitionContractFanToken = () => {
  const { data: signer } = useWalletClient();
  return useMemo(
    () => getTradingCompetitionContractFanToken(signer ?? undefined),
    [signer]
  );
};
...
export const useTradingCompetitionContractMobox = () => {
  const { data: signer } = useWalletClient();
  return useMemo(
    () => getTradingCompetitionContractMobox(signer ?? undefined),
    [signer]
  );
};
...
export const useTradingCompetitionContractMoD = () => {
  const { data: signer } = useWalletClient();
  return useMemo(
    () => getTradingCompetitionContractMoD(signer ?? undefined),
    [signer]
  );
};
...
export const useCakeVaultContract = () => {
  ...
  const { chainId } = useActiveChainId();
  return useMemo(
    () => getCakeVaultV2Contract(signer ?? undefined, chainId),
    [signer, chainId]
  );
};
...
export const useChainlinkOracleContract = (address) => {
  const { data: signer } = useWalletClient();
  return useMemo(
    () => getChainlinkOracleContract(address, signer ?? undefined),
    [signer, address]
  );
};
...
export function useWBETHContract() {
  ...
  const abi = useMemo(
    () =>
      chainId && [ChainId.MODE_MAINNET, ChainId.MODE_TESTNET].includes(chainId)
        ? wbethEthABI
        : wbethBscABI,
    [chainId]
  );
...
export const usePotterytVaultContract = (address: Address) => {
  const { data: signer } = useWalletClient();
  return useMemo(
    () => getPotteryVaultContract(address, signer ?? undefined),
    [address, signer]
  );
};
...
export function useBCakeFarmBoosterContract() {
  const { data: signer } = useWalletClient();
  return useMemo(
    () => getBCakeFarmBoosterContract(signer ?? undefined),
    [signer]
  );
}
...
export function useBCakeFarmBoosterV3Contract() {
  ...
  const { data: signer } = useWalletClient();
  return useMemo(
    () => getBCakeFarmBoosterV3Contract(signer ?? undefined, chainId),
    [signer, chainId]
  );
}
...
export function useBCakeFarmBoosterProxyFactoryContract() {
  const { data: signer } = useWalletClient();
  return useMemo(
    () => getBCakeFarmBoosterProxyFactoryContract(signer ?? undefined),
    [signer]
  );
}
...
export function useBCakeProxyContract(proxyContractAddress: Address) {
  ...
  return useMemo(
    () =>
      ...
      getBCakeProxyContract(proxyContractAddress, signer ?? undefined),
...
export const useNonBscVault = () => {
  ...
  const { data: signer } = useWalletClient();
  return useMemo(
    () => getNonBscVaultContract(signer ?? undefined, chainId),
    [signer, chainId]
  );
};
...
export const useUNSContract = (address, chainId, provider) => {
  return useMemo(
    () => getUnsContract(address, chainId, provider),
...
export const useStableSwapNativeHelperContract = () => {
  ...
  const { data: signer } = useWalletClient();
  return useMemo(
    () => getStableSwapNativeHelperContract(signer ?? undefined, chainId),
    [signer, chainId]
  );
};
...
export function useMasterchefV3() {
  ...
  const { data: signer } = useWalletClient();
  return useMemo(
    () => getMasterChefV3Contract(signer ?? undefined, chainId),
    [signer, chainId]
  );
}
...
export function useV3MigratorContract() {
  ...
  const { data: signer } = useWalletClient();
  return useMemo(
    () => getV3MigratorContract(signer ?? undefined, chainId),
    [chainId, signer]
  );
}
...
export const useTradingRewardContract = ({
  ...
  const { data: signer } = useWalletClient();
  return useMemo(
    () => getTradingRewardContract(signer ?? undefined, chainId_ ?? chainId),
...
export const useAffiliateProgramContract = ({
  chainId: chainId_,
}: { chainId?: ChainId } = {}) => {
  const { chainId } = useActiveChainId();
  const { data: signer } = useWalletClient();
...
export const useVCakeContract = ({
  chainId: chainId_,
}: { chainId?: ChainId } = {}) => {
  const { chainId } = useActiveChainId();
  const { data: signer } = useWalletClient();
  return useMemo(
    () => getVCakeContract(signer ?? undefined, chainId_ ?? chainId),
    [signer, chainId_, chainId]
  );
};
...
export const useFixedStakingContract = () => {
  ...
  return useMemo(
    () => getFixedStakingContract(signer ?? undefined, chainId),
    [chainId, signer]
  );
};
...
export const useVeCakeContract = () => {
  ...
  return useMemo(
    () => getVeCakeContract(signer ?? undefined, chainId),
    [chainId, signer]
  );
};
...
export const useGaugesVotingContract = () => {
  ...
  return useMemo(
    () => getGaugesVotingContract(signer ?? undefined, chainId),
    [chainId, signer]
  );
};
...
export const useCalcGaugesVotingContract = () => {
  ...
  return useMemo(
    () => getCalcGaugesVotingContract(signer ?? undefined, chainId),
    [chainId, signer]
  );
};
...
export const useRevenueSharingCakePoolContract = () => {
  ...
  return useMemo(
    () => getRevenueSharingCakePoolContract(signer ?? undefined, chainId),
    [signer, chainId]
  );
};
...
export const useRevenueSharingVeCakeContract = () => {
  ...
  return useMemo(
    () => getRevenueSharingVeCakeContract(signer ?? undefined, chainId),
    [signer, chainId]
  );
};
...
export const useRevenueSharingPoolGatewayContract = () => {
  ...
  return useMemo(
    () => getRevenueSharingPoolGatewayContract(signer ?? undefined, chainId),
    [signer, chainId]
  );
};
