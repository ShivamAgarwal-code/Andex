...
const whitelist = [
  ...
  `Don't let that dopey smile deceive you... Churro's a master ANDX chef!`,
  `Nommm... Oh hi, I'm just meditating on the meaning of ANDX.`,
  `Three guesses what's put that twinkle in those eyes! (Hint: it's ANDX)`,
  ...
  "Sort Title Z-A",
  "All articles",
  "Learn basics of Andex",
  "Learn how",
  "You might also like",
  "Chef’s choice",
  "Recommended Readings by Chefs",
  "Latest News about Andex and more!",
  "Gaming Announcements",
  "Andex Gaming Community",
  "Gaming Community",
  ...
  "Start Building",
  "Build Games with Andex Now",
  "Bring Your Game to Life on Andex",
  ...
  "Integrate ANDX tokens and NFTs to enrich the gaming experience",
  "Build Games with the most reputable global brand in the industry",
  "Explore Top Blockchains",
  "Andex operates on 9 popular blockchains, welcoming developers from diverse ecosystems",
  ...
  "Andex Gaming Marketplace",
  "Play, Build and Connect on Andex",
  "Flagship",
  "Published By",
  "Publish Date: %date%",
  "Publisher:",
...
describe("Check translations available", () => {
  ...
  function throughDirectory(directory, includeJs = false) {
    fs.readdirSync(directory).forEach((file) => {
      ...
      if (
        (absolute.includes(".tsx") ||
          absolute.includes(".ts") ||
          (includeJs && absolute.includes(".js"))) &&
