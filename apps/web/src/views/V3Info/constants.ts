...
export const TOKEN_HIDE: { [key: string]: string[] } = {
  ...
  // ],
  [ChainId.MODE_MAINNET]: ['0xdb19f2052D2B1aD46Ed98C66336A5dAADEB13005', '0x57a63C32CC2aD6CE4FBE5423d548D12d0EEDdfc1'],
}
...
export const SUBGRAPH_START_BLOCK = {
  [ChainId.MODE_MAINNET]: 7604016,
  [ChainId.MODE_TESTNET]: 7604016,
