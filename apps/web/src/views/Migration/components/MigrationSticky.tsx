...
export const TEXT = {
  v2: {
    ...
    steps: [
      {
        title: <Trans>Unstaking LP Tokens and ANDX</Trans>,
        subTitle: (
          <Trans>
            All the earned ANDX will be harvested to your wallet upon unstake.
          </Trans>
        ),
      ...
      },
      {
        ...
        subTitle: (
          <Trans>
            Each farm and pool has to be individually enabled before staking.
          </Trans>
        ),
  ...
  v3: {
    title: <Trans>Andex v3 Migration</Trans>,
    steps: [
      {
      ...
      },
      {
        ...
        subTitle: (
          <Trans>
            All trading fee earnings are included in the tokens returned.
          </Trans>
        ),
        button: <Trans>Next Steps</Trans>,
      },
      {
        ...
        subTitle: (
          <Trans>
            Before you provide liquidity, please read make sure you are familiar
            with how to provide liquidity in V3.
          </Trans>
        ),
        button: <Trans>Next Steps</Trans>,
      },
      ...
      },
      {
        ...
        subTitle: (
          <Trans>
            Start earning ANDX by staking your liquidity positions to V3 Farms!
          </Trans>
        ),
...
const MigrationSticky: React.FC<
  React.PropsWithChildren<MigrationStickyProps>
> = ({ step, handleClick, version }) => {
    ...
    return (
      <Container>
        <TextGroup>
          ...
          <TextSubTitle>
            {t("Please connect wallet to check your pools & farms status.")}
          </TextSubTitle>
        </TextGroup>
