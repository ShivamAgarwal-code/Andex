...
} from "views/Home/components/Banners/images";
  ...
  return (
    <div ref={tableWrapperEl}>
        ...
        <RowBetween flexWrap="nowrap">
          ...
          >
            ...
            <AutoColumn gap="4px" pt="4px">
              <Link
                href="https://docs.pancakeswap.finance/code/v3-migration/how-to-migrate"
                external
              >
              ...
              <Link
                href="https://docs.pancakeswap.finance/code/v3-migration/faq"
                external
              >
                <Button p="0" variant="text" scale="sm">
                  <Text color="primary" bold fontSize="16px" mr="4px">
          ...
          >
            <Image
              src={farmV3MigrationBunny}
              alt="farmV3MigrationBunny"
              width={300}
              height={230}
              placeholder="blur"
            />
      ...
      <MigrationSticky
        version="v3"
        step={step}
        handleClick={handleMigrationStickyClick}
      />
    </div>
  );
};
