...
import {
  ...
  DatePickerPortal,
  TimePicker,
} from "views/Voting/components/DatePicker";
import { useAccount, useWalletClient } from "wagmi";
import Layout from "../components/Layout";
import VoteDetailsModal from "../components/VoteDetailsModal";
import { ADMINS, PANANDX_SPACE, VOTE_THRESHOLD } from "../config";
            ...
            <Card>
              ...
              <CardBody>
                <Box mb="24px">
                  ...
                  />
                  {formErrors.startDate && fieldsState.startDate && (
                    <FormErrors errors={formErrors.startDate} />
                  )}
                </Box>
                <Box mb="24px">
                  ...
                  />
                  {formErrors.startTime && fieldsState.startTime && (
                    <FormErrors errors={formErrors.startTime} />
                  )}
                </Box>
                <Box mb="24px">
                  ...
                  <DatePicker
                    ...
                    placeholderText="YYYY/MM/DD"
                  />
                  {formErrors.endDate && fieldsState.endDate && (
                    <FormErrors errors={formErrors.endDate} />
                  )}
                </Box>
                <Box mb="24px">
                  ...
                  <TimePicker
                    ...
                    placeholderText="00:00"
                  />
                  {formErrors.endTime && fieldsState.endTime && (
                    <FormErrors errors={formErrors.endTime} />
                  )}
                </Box>
                {account && (
                ...
                <Flex alignItems="center" mb="16px">
                  ...
                  <ScanLink
                    useBscCoinFallback
                    href={getBlockExploreLink(snapshot, "block")}
                  >
                    {snapshot}
                  </ScanLink>
                </Flex>
