...
const StepCard: React.FC<React.PropsWithChildren<{ step: Step }>> = ({
  step,
}) => {
  return (
    ...
    <StyledStepCard width={["280px", "330px", "380px"]}>
      <StepCardInner height="auto">
        ...
        <AllocationGrid>
          <AllocationMatch
            color="#FFE362"
            text={t("Matches first %digits%", { digits: 1 })}
          />
          ...
          <AllocationMatch
            color="#85C54E"
            text={t("Matches first %digits%", { digits: 2 })}
          />
          <Text textAlign="right" bold>
            3%
          </Text>
          <AllocationMatch
            color="#028E75"
            text={t("Matches first %digits%", { digits: 3 })}
          />
          <Text textAlign="right" bold>
            5%
          </Text>
          <AllocationMatch
            color="#36E8F5"
            text={t("Matches first %digits%", { digits: 4 })}
          />
          <Text textAlign="right" bold>
            10%
          </Text>
          <AllocationMatch
            color="#A881FC"
            text={t("Matches first %digits%", { digits: 5 })}
          />
          <Text textAlign="right" bold>
            20%
          </Text>
        ...
        <Flex maxWidth="300px" flexDirection="column">
          ...
          <Text>
            ...
            <InlineLink href="https://docs.pancakeswap.finance/products/lottery/lottery-guide">
              {t("how to play the Andex lottery!")}
            </InlineLink>
          </Text>
        </Flex>
      </Flex>
