...
const WelcomePage: React.FC<React.PropsWithChildren<WelcomePageProps>> = ({
  isLoading,
  onDismiss,
  handleStartNow,
}) => {
  ...
  const isDiscountZero = useMemo(
    () => new BigNumber((discount as string) ?? "0").eq(0),
    [discount]
  );
  ...
  return (
    <Flex
      ...
      padding={["24px", "24px", "24px", "24px", "50px 24px"]}
    >
      <Box>
      ...
      <Box>
        ...
        <Text color="textSubtle" fontSize="14px" mb="24px">
          {t("has referred you to start trading on Andex")}
        </Text>
          ...
          <Flex alignItems="center">
            ...
            <Text fontSize="14px" ml="8px">
              ...
              <Text display="inline-block" as="span" ml="4px">
                <Link
                  external
                  href="https://docs.pancakeswap.finance/affiliate-program/terms-and-conditions"
                >
