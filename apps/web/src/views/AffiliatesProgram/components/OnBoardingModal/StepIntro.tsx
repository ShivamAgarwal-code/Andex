...
const IntroSteps = [
  {
    ...
    description: (
      <Trans>
        We offer the lowest fees in the industry, giving you more value for your
        trades
      </Trans>
    ),
  },
  {
    ...
    description: (
      <Trans>
        Experience true decentralization with our exchange, offering you
        complete control over your trades in a secure and easy-to-use
        environment
      </Trans>
    ),
  },
  ...
  return (
    ...
    >
      <Box
        ...
        borderRadius={radius}
        background={
          active ? theme.colors.secondary : theme.colors.inputSecondary
        }
      />
    </Flex>
  );
