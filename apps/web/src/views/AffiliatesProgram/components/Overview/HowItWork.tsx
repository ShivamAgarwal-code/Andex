  ...
  return (
    ...
    >
      ...
      <Text textAlign="center" color="textSubtle">
        {t("Together we can make the Andex community even stronger")}
      </Text>
      <Text textAlign="center" color="textSubtle" bold mb="32px">
        {t("How do you Become a Andex Affiliate?")}
      </Text>
      <Flex
        width={["280px", "280px", "280px", "888px"]}
        flexDirection={["column", "column", "column", "row"]}
      >
        <Flex
          width={["100%", "100%", "100%", "33.33%"]}
          m={["0 0 16px 0", "0 0 16px 0", "0 0 16px 0", "0 16px 0 0"]}
        >
        ...
        <Flex width={["100%", "100%", "100%", "33.33%"]}>
          <Card>
            <Box padding={["24px"]}>
              ...
              <Text fontSize={["14px"]} mt="24px">
                {t("Earn up to 20% referral commissions in ANDX")}
              </Text>
            </Box>
          </Card>
        </Flex>
