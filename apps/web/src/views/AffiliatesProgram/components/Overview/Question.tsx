    ...
    >
      <Wrapper>
        ...
        <Card>
          ...
          <StyledCardBody>
            <FoldableText
              title={t("What is the criteria to become a Andex affiliate?")}
              mt="24px"
            >
              ...
              <StyledListText color="textSubtle">
                {t("Strong understanding of Andex and our ecosystem")}
              </StyledListText>
            </FoldableText>
            <FoldableText
              title={t("How do I earn commissions as an affiliate?")}
              mt="24px"
            >
              <StyledListText color="textSubtle">
                {t(
              ...
              <StyledListText ml="16px" color="textSubtle">
                {t(
                  "Pairs must be in the Andex Token list for the following chains ("
                )}
                <Link
                  external
            ...
            >
              ...
              <StyledListText color="textSubtle">
                {t(
                  "You will be able to redeem your ANDX rewards from the affiliate dashboard page. Once redeemed, Andex will transfer the commission amount earned to your designated wallet. You will be able to see the details of each payment in your affiliate dashboard, including the amount, date, and status of each payment."
                )}
              </StyledListText>
            </FoldableText>
            <FoldableText
              title={t("How do I track my referrals and commissions?")}
              mt="24px"
            >
              <StyledListText color="textSubtle">
                {t(
            ...
            <FoldableText
              title={t("Is there a limited number of referrals i can refer?")}
              mt="24px"
            >
              <StyledListText color="textSubtle">
