...
const BenefitsList = [
  {
    ...
    desc: (
      <Trans>
        Forge a partnership with the most reputable global brand in the industry
        to make DeFi accessible and better for everyone
      </Trans>
    ),
  ...
  },
  {
    ...
    desc: (
      <Trans>
        Provide a seamless experience for your referrals with our user friendly
        platform
      </Trans>
    ),
  ...
  },
  {
    ...
    desc: (
      <Trans>
        Easily keep tabs on commission and earnings with our user-friendly
        dashboard
      </Trans>
    ),
    ...
    >
      <Flex alignItems="center" flexDirection="column" justifyContent="center">
        ...
        <Heading maxWidth={["700px"]} textAlign="center" scale="xl">
          {t("Unlock the Power of Andex Affiliate Benefits")}
        </Heading>
        <StyledContainer>
