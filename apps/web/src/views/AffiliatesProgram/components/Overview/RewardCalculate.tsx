...
import {
  floatingStarsLeft,
  floatingStarsRight,
} from "views/Lottery/components/Hero";
...
const RewardCalculate = () => {
  ...
  return (
    ...
    >
      <Decorations>
        <img
          src="/images/affiliates-program/m-1.png"
          width="110px"
          height="79px"
          alt=""
        />
        <img
          src="/images/affiliates-program/m-2.png"
          width="295.89px"
          height="226px"
          alt=""
        />
        <img
          src="/images/affiliates-program/m-3.png"
          width="42px"
          height="29px"
          alt=""
        />
        <img
          src="/images/affiliates-program/m-4.png"
          width="210px"
          height="210px"
          alt=""
        />
        <img
          src="/images/affiliates-program/m-5.png"
          width="72px"
          height="63px"
          alt=""
        />
        ...
        >
          <Box m={["32px 0"]}>
            <Text
              ...
              bold
            >
              {t("Join Andex's Community and Make a Difference")}
            </Text>
          </Box>
          <Text
            textAlign={["left", "left", "left", "center"]}
          ...
          >
            {t(
              "As an affiliate, you'll be part of a network of like-minded individuals who are committed to build a stronger DeFi community. Be part of something bigger with Andex's Affiliate program"
            )}
          </Text>
          <Link
            external
