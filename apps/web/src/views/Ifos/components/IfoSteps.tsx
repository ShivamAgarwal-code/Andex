...
const Step1 = ({
  ...
  const creditDollarValue = cakePrice
    .multipliedBy(balanceNumber ?? 1)
    .toNumber();
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t("You’ll need an active Andex Profile to take part in an IFO!")}
            </Text>
            {renderAccountStatus()}
          </CardBody>
        );
