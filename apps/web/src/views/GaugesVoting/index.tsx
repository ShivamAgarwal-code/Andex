  ...
  return (
    <StyledGaugesVotingPage>
      <StyledPageHeader background="transparent">
        ...
        >
          <Flex flex="1" flexDirection="column" mr={["8px", 0]}>
            ...
            <Box maxWidth="537px">
              <Text color="textSubtle">
                {t("Use veANDX to vote and determine ANDX emissions.")}
                <InlineLink
                  external
                  showExternalIcon
                  color="textSubtle"
          ...
          <Flex justifyContent="flex-end">
            <img
              src="/images/gauges-voting/landing-bunny.png"
              alt="bunny"
              width="218px"
            />
          </Flex>
      ...
      <Page style={{ paddingTop: 0, marginTop: "-18px" }}>
        <Card
          innerCardProps={{
            padding: isDesktop ? "2em 2em 0 2em" : "1em 1em 0 1em",
          }}
        >
          <Grid gridTemplateColumns={isDesktop ? "2fr 3fr" : "1fr"}>
            <FlexGap flexDirection="column" gap="24px">
              ...
              <Text color="textSubtle" fontSize={12}>
                {t(
                  "Results are updated weekly. Vote numbers are estimations based on the veANDX balance at 00:00 UTC on the upcoming Thursday."
                )}
              </Text>
            </FlexGap>
