...
const config = ({ t }: FAQsType) => [
  {
    ...
    description: [
      <Text key={1} color="textSubtle">
        {t(
          "The smart contract address will be released soon before the sale starts."
        )}
      </Text>,
    ],
  },
  ...
  },
  {
    ...
    description: [
      t(
        "100% of ANDX spent on Pancake Squad NFTs will be burned as part of our weekly ANDX burn."
      ),
    ],
  },
  {
