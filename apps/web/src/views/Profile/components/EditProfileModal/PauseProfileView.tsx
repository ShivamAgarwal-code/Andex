...
const PauseProfilePage: React.FC<
  React.PropsWithChildren<PauseProfilePageProps>
> = ({ onDismiss, onSuccess }) => {
  ...
  return (
    <>
      ...
      <Text as="p" color="textSubtle" mb="24px">
        {t("Cost to reactivate in the future: %cost% ANDX", {
          cost: formatBigInt(numberCakeToReactivate),
        })}
      </Text>
      <label
