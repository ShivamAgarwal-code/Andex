...
const AllocationMatch: React.FC<
    ...
    <StyledStepCard width={["100%", "280px", "330px", "380px"]}>
      <StepCardInner height="auto">
        <Flex mb="34px" justifyContent="center">
          <Image
            alt="pottery-prize-chart"
            width={103}
            height={103}
            src="/images/pottery/chart.svg"
          />
        </Flex>
        <AllocationGrid>
