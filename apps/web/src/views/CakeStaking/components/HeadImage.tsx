    ...
    <AtomBox display="flex" alignItems="center">
      ...
      >
        <SpeechBubbleBox display="flex">
          <Button
            variant="subtle"
            endIcon={<HelpIcon color="invertedContrast" width="24px" />}
          >
            {t("New to ANDX Staking")}
          </Button>
          <SpeechBubble width="16px" height="16px" />
        </SpeechBubbleBox>
      </Link>
      <img
        src="/images/cake-staking/new-staking-bunny.png"
        alt="new-staking-bunny"
        width="138px"
      />
    </AtomBox>
  );
...
export const HeadImage = () => {
  ...
  return (
    ...
    >
      <Button
        variant="subtle"
        endIcon={<HelpIcon color="white" width="24px" />}
        mt="1em"
      >
