...
export const CardWrapper = styled.div`
  border-radius: 24px;
  background: ${({ theme }) =>
    theme.isDark ? theme.colors.gradientBubblegum : theme.colors.backgroundAlt};
  width: 100%;
...
const useTradeBlockData = () => {
  ...
  return useMemo(() => {
    ...
    perpetualUrl,
    onUSCitizenModalPresent,
    userNotUsCitizenAcknowledgement,
  ]);
};
    ...
    >
      ...
      <CardWrapper>
        ...
        >
          <Image
            style={{
              marginRight: isMobile || isMd ? "auto" : -72,
              marginLeft: isMobile || isMd ? 0 : "auto",
            }}
            src={earnNftBunny}
            alt="earnNftBunny"
            width={296}
