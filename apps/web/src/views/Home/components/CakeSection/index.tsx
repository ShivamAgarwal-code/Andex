...
const borderBoxAnimation = css`
  &:before {
    ...
    width: 60%;
    height: 110%;
    transition: transform ${COVER_TRANSITION_TIMES}s ease-in-out
      ${LINE_TRANSITION_TIMES}s;
    background: ${({ theme }) =>
      theme.isDark
  ...
  return (
    ...
    >
      ...
      <Flex justifyContent="center">
        ...
        >
          {t(
            "Experience the power of community ownership, global governance, and explore infinite use cases within the Andex ecosystem"
          )}
        </Text>
      </Flex>
      <Flex justifyContent="center" style={{ gap: 14 }}>
        <Link href="https://andex.vercel.app/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82&chainId=56">
          <Button variant="primary">{t("Buy ANDX")}</Button>
        </Link>
        <Link href="https://docs.pancakeswap.finance/governance-and-tokenomics/cake-tokenomics">
          <Button
            pl="0"
            endIcon={<OpenNewIcon color="primary" />}
            variant="text"
          >
            {t("Learn")}
          </Button>
      ...
      <CakeSectionMainBox>
        ...
        <CakeSectionLeftBox>
          ...
          >
            ...
            <EcoSystemTagOuterWrapper>
              <FeatureTagsWrapper
                direction={isMobile || isTablet ? "right" : "up"}
              >
