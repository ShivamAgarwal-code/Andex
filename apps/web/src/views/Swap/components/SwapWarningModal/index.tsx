...
const SwapWarningModal: React.FC<
  React.PropsWithChildren<SwapWarningModalProps>
> = ({ swapCurrency, onDismiss }) => {
  ...
  return (
    <StyledModalContainer minWidth="280px">
      <ModalHeader background={theme.colors.gradientCardHeader}>
        <Heading p="12px 24px">
          {t("Notice for trading %symbol%", { symbol: SWAP_WARNING?.symbol })}
        </Heading>
      </ModalHeader>
      <ModalBody p="24px">
