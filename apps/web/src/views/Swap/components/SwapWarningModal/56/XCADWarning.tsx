...
const XCADWarning = () => {
  ...
  return (
    <Box maxWidth="380px">
      <Text>
        {t(
          "XCAD is now using a new bridge provider and has migrated to a new XCAD token on BSC."
        )}
        <br />
        {t(
          "You can obtain the new token either by swapping your old tokens on Andex or bridging them to ETH and back to BSC using the new bridge provider."
        )}
        <br />
