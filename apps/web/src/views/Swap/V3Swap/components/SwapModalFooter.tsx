        ...
        <RowBetween>
                ...
                isMM ? (
                  <>
                    <Text mb="12px">
                      ...
                      :{" "}
                      {t(
                        "For each non-stableswap trade, a %amount% fee is paid",
                    ...
                    <Text mt="10px">
                      ...
                      :{" "}
                      {t(
                        "Andex does not charge any fees for trades. However, the market makers charge an implied fee of 0.05% - 0.25% (non-stablecoin) / 0.01% (stablecoin) factored into the quotes provided by them."
                      )}
                    </Text>
                  </>
                ) : (
          ...
          {realizedLPFee ? (
            <Flex>
              ...
              <CurrencyLogo
                currency={
                  currencyBalances.INPUT?.currency ?? inputAmount.currency
                }
                size="24px"
              />
            </Flex>
