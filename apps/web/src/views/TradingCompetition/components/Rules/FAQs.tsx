        ...
        <StyledCardbody>
          <FoldableText title={t("Eligible trading pairs")} mt="24px">
            <Text fontSize="14px" color="textSubtle">
              {t(
                "Only trades on DAR/BNB, ANDX/BNB, and ANDX/BUSD pairs will be included in volume calculations. Please note that the volume from limit orders will not be included."
              )}
            </Text>
          </FoldableText>
          <FoldableText
            title={t("Calculating team ranks and winners")}
            mt="24px"
          >
            <Text fontSize="14px" color="textSubtle">
              -{" "}
          ...
          <FoldableText title={t("Prize distribution")} mt="24px">
            <Text fontSize="14px" color="textSubtle">
              -{" "}
              {t(
                "Prizes to be distributed in ANDX and DAR in a distribution of 1:5 and shared by all members of each respective tier."
              )}
            </Text>
            <Text fontSize="14px" color="textSubtle">
              -{" "}
              {t(
                "The price of token prizes ($ANDX and $DAR) in USD will be determined as per their BUSD pair price during the tally period."
              )}
            </Text>
            <Text fontSize="14px" color="textSubtle">
              -{" "}
          ...
          <FoldableText title={t("Fine print")} mt="24px">
            <Text fontSize="14px" color="textSubtle">
              -{" "}
              {t(
                "In the event of a disagreement concerning the final winning team or rank, Andex will have the final say."
              )}
            </Text>
            <Text fontSize="14px" color="textSubtle">
              -{" "}
              {t(
                "Andex can and will disqualify any team or specific members that are proven to have taken malicious action or attempt to “cheat” in any way."
              )}
            </Text>
          </FoldableText>
          <FoldableText
            title={t("Can I join the battle after it starts?")}
            mt="24px"
          >
            <Text fontSize="14px" color="textSubtle">
              {t(
          ...
          <FoldableText
            title={t("How do I know if I successfully registered?")}
            mt="24px"
          >
            <Text fontSize="14px" color="textSubtle">
              {t(
