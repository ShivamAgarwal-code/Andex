...
const MoboxPrizesText = () => {
  ...
  return (
    <StyledFlex flexDirection="column" mb="32px">
      ...
      <Text mt="8px">
        {t(
          "In addition to token prizes there are NFT rewards (estimated worth of ~$40,000 at the time of writing):"
        )}
      </Text>
      <Flex>
        ...
        <Text mt="8px">
          {t(
            "300 Mobox Avatars NFT + 300 Andex newly designed NFT to the top 100 traders in each of the three teams."
          )}
        </Text>
      </Flex>
      <Flex>
        ...
        <Text mt="8px">
          {t(
            "500 Mobox mystery boxes to the top 500 traders ranked by the MBOX trading volume."
          )}
        </Text>
      </Flex>
      <ImageWrapper>
        <Image
          src={MoboxFlipperBunny}
          alt="Flipper bunny"
          width={220}
          height={254}
        />
