...
const MoboxUserPrizeGrid: React.FC<
  React.PropsWithChildren<{ userTradingInformation?: UserTradingInformation }>
> = ({ userTradingInformation }) => {
  ...
  const { cakeReward, moboxReward, dollarValueOfTokensReward } =
    useMoboxCompetitionRewards({
      userCakeRewards,
      userMoboxRewards,
    });
