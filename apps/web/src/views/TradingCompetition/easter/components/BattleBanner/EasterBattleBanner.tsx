...
import {
  Heading1Text,
  Heading2Text,
} from "../../../components/CompetitionHeadingText";
...
const EasterBattleBanner = () => {
  ...
  return (
    <Flex flexDirection="column">
      ...
      <StyledHeading
        scale="md"
        color={theme.isDark ? "textSubtle" : "inputSecondary"}
        mt="16px"
      >
        {t(
          "Compete with other teams to win ANDX, collectible NFTs, achievements & more!"
        )}
      </StyledHeading>
    </Flex>
  );
