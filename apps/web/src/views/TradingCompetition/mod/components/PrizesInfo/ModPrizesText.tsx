...
const ModPrizesText = () => {
  ...
  return (
    <StyledFlex flexDirection="column" mb="32px">
      ...
      <Text mt="10px">
        {t("In addition to token prizes there are NFT rewards:")}
      </Text>
      <Text>
        A.{" "}
        {t(
          "300 newly-designed Andex NFTs to the Top 100 Traders in each team."
        )}
      </Text>
      <Text>
        B.{" "}
        {t(
          "100 Mines of Dalarnia NFTs to the Top 100 Traders ranked by the $DAR Trading Volume."
        )}
      </Text>
      <ImageWrapper>
        <Image
