  ...
  return [
    {
      ...
      description: [
        ...
        t(
          "You can instantly swap your WBNB for BNB with no trading fees on Andex."
        ),
      ],
    },
    {
    ...
    },
    {
      ...
      description: [
        t(
          "100% of all platform fees taken by Andex from sales are used to buy back and BURN ANDX tokens in our weekly ANDX burns."
        ),
        t(
          "Platform fees: 2% is subtracted from NFT sales on the market. Subject to change.Collection fees: Additional fees may be taken by collection creators, once those collections are live. These will not contribute to the ANDX burns."
        ),
      ],
    },
  ];
