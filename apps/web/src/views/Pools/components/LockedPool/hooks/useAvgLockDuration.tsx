...
import formatSecondsToWeeks, {
  secondsToWeeks,
} from "../../utils/formatSecondsToWeeks";
    ...
    return (
      Math.round(
        avgBoostRatio
          ...
          .div(
            new BigNumber(BOOST_WEIGHT.toString()).div(
              getFullDecimalMultiplier(12)
            )
          )
          .toNumber()
      ) || 0
