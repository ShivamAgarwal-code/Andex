...
import { ANDX, USDC, USDT, WBTC_ETH } from "./common";

//TODO: change the details

export const ethereumTokens = {
  weth: WETH9[ChainId.MODE_MAINNET],
  usdt: USDT[ChainId.MODE_MAINNET],
  usdc: USDC[ChainId.MODE_MAINNET],
  wbtc: WBTC_ETH,
  sdao: new ERC20Token(
  ...
  cake: ANDX[ChainId.MODE_MAINNET],
  dai: new ERC20Token(
    ChainId.MODE_MAINNET,
