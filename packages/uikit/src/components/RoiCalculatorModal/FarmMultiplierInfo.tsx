...
export const FarmMultiplierInfo: React.FC<React.PropsWithChildren<FarmMultiplierInfoProps>> = ({
  ...
  return (
    <>
      ...
      <Text my="24px">
        {t(
          "The Farm Multiplier represents the proportion of ANDX rewards each farm receives as a proportion of its farm group.",
        )}
      </Text>
      <Text my="24px">
        {t("For example, if a 1x farm received 1 ANDX per block, a 40x farm would receive 40 ANDX per block.")}
      </Text>
      <Text>
